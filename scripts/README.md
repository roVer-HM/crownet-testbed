...
📌 All scripts are made available on the **master node** of the testbed, which controls all host nodes.
...
- ⏱️ `sync_time.py` — restart chrony and synchronize node clocks with the master node
