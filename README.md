...
sudo docker run --rm --network host \
-e "SERVER_ADDRESS=0.0.0.0" \
-e "EXPERIMENTAL_WIFI_IP=192.168.1.4" \
-e "EXPERIMENTAL_BROADCAST_IP=192.168.1.255" \
-e "EXPERIMENTAL_WIFI_SENDING_PORT=5005" \
-e "EXPERIMENTAL_WIFI_RECEIVING_PORT=5006" \
-e "EXPERIMENTAL_PAYLOAD_SENDING_PORT=5007" \
...
sudo docker run --rm --network host \
-e "SERVER_ADDRESS=0.0.0.0" \
-e "EXPERIMENTAL_WIFI_IP=192.168.1.5" \
-e "EXPERIMENTAL_BROADCAST_IP=192.168.1.255" \
-e "EXPERIMENTAL_WIFI_SENDING_PORT=5005" \
-e "EXPERIMENTAL_WIFI_RECEIVING_PORT=5006" \
-e "EXPERIMENTAL_PAYLOAD_SENDING_PORT=5007" \
...
sudo docker run --rm --network host \
-e "SERVER_ADDRESS=0.0.0.0" \
-e "EXPERIMENTAL_WIFI_IP=192.168.1.6" \
-e "EXPERIMENTAL_BROADCAST_IP=192.168.1.255" \
-e "EXPERIMENTAL_WIFI_SENDING_PORT=5005" \
-e "EXPERIMENTAL_WIFI_RECEIVING_PORT=5006" \
-e "EXPERIMENTAL_PAYLOAD_SENDING_PORT=5007" \
...
sudo docker run --rm --network host \
-e "SERVER_ADDRESS=0.0.0.0" \
-e "EXPERIMENTAL_WIFI_IP=192.168.1.7" \
-e "EXPERIMENTAL_BROADCAST_IP=192.168.1.255" \
-e "EXPERIMENTAL_WIFI_SENDING_PORT=5005" \
-e "EXPERIMENTAL_WIFI_RECEIVING_PORT=5006" \
-e "EXPERIMENTAL_PAYLOAD_SENDING_PORT=5007" \
...
sudo docker run --rm --network host \
-e "SERVER_ADDRESS=0.0.0.0" \
-e "EXPERIMENTAL_WIFI_IP=192.168.1.8" \
-e "EXPERIMENTAL_BROADCAST_IP=192.168.1.255" \
-e "EXPERIMENTAL_WIFI_SENDING_PORT=5005" \
-e "EXPERIMENTAL_WIFI_RECEIVING_PORT=5006" \
-e "EXPERIMENTAL_PAYLOAD_SENDING_PORT=5007" \
...
sudo docker run --rm --network host \
-e "SERVER_ADDRESS=0.0.0.0" \
-e "EXPERIMENTAL_WIFI_IP=192.168.1.9" \
-e "EXPERIMENTAL_BROADCAST_IP=192.168.1.255" \
-e "EXPERIMENTAL_WIFI_SENDING_PORT=5005" \
-e "EXPERIMENTAL_WIFI_RECEIVING_PORT=5006" \
-e "EXPERIMENTAL_PAYLOAD_SENDING_PORT=5007" \
